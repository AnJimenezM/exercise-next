...
const Layout = ({children, footer = true}) => {
  ...
  useEffect(()=>{
    ...
    return ()=>{
      ...
      router.events.off('routeChangeStart', handleChangeComplete)
      router.events.off('routeChangeStart', handleChangeError)
    } 
  },[router.events])
  return (
    <>
    ...
    {footer && (
      <footer className='bg-dark text-light text-center'>
        <div className='contaiiner p-4'>
          <h1>&copy; Andres Jimenez</h1>
